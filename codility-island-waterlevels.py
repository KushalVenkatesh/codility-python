...
# solution([randint(0, 100000) for x in range(30000)],B = [randint(0, 100000) for x in range(30000)]) #Performance test
# print solution ([9, 6, 10, 10, 1, 9, 6, 10, 2, 2, 8, 6], [3, 9, 2])
# print solution([2, 1, 3, 2, 3], [0, 1, 2, 3, 1])
# print solution([4, 5, 8, 5, 1, 4, 6, 8, 7, 2, 2, 5], [9, 9, 4])